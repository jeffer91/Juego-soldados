(() => {
  ...
  function showError(error) {
    console.error('RBTwar v24 no pudo iniciar:', error);
  ...
  console.info('RBTwar bootstrap v24');
  ...
  fetch(ENGINE_URL, { cache: 'no-store' })
    ...
    .then(source => {
      ...
      code = code.replace(
        ...
        "const STORAGE_KEY='rbtwar-save-v24',MAX_LEVEL=30;"
      );
      code = code.replace(
        "for(const key of [STORAGE_KEY,'rbtwar-save-v6'",
        "for(const key of [STORAGE_KEY,'rbtwar-save-v23','rbtwar-save-v22','rbtwar-save-v21','rbtwar-save-v20','rbtwar-save-v19','rbtwar-save-v18','rbtwar-save-v12','rbtwar-save-v11','rbtwar-save-v10','rbtwar-save-v9','rbtwar-save-v8','rbtwar-save-v7','rbtwar-save-v6'"
      );
...
`;
      ...
      script.dataset.rbtwarEngine = 'v24-stable';
